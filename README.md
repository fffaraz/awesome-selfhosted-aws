...
* [rustfs](https://garagehq.deuxfleurs.fr/) – An open-source high-performance distributed object storage software built using Rust.
  
## Amazon CloudWatch
* [Prometheus](https://prometheus.io/) - An open-source monitoring and alerting toolkit.
* [Grafana](https://github.com/rustfs/rustfs) - An open-source platform for monitoring and observability.
